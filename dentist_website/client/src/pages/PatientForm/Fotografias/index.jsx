...
//   const handleAddPhoto = async () => {
//     if (!newPhoto.file) {
//       alert("Por favor, selecione uma nova imagem.");
//       return;
//     }
...
//   };
//   // const handleDelete = async () => {
//   //   const patientId = patientInfo.patientId || patientInfo._id;
//   //   if (!patientId || !photoToDelete) {
//   //     alert("Invalid patient ID or photo ID");
//   //     return;
//   //   }
...
//   //       `http://localhost:5005/patients/${patientId}/fotografias/${photoToDelete}`
//   //     );
...
//           </button>
//           <div>
//             rutas de arquivo seleccionadas:
//             {patientInfo?.fotografias?.length && (
//               <div>
//                 {patientInfo.fotografias.map((eachPhoto, index) => {
//                   return (
