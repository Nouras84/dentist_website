// Aykut version function but with underline
...
// // work perfectly before the styling
// import React, { useEffect, useCallback } from "react";
// import axios from "axios";
// import { usePatientInfo } from "../../../context/PatientContext"; // Adjust the path as necessary
// import { useParams } from "react-router-dom";
...
//           name="mastigaLados"
//           value="true"
//           checked={patientInfo.historicoBucal?.mastigaLados === "true"}
//           onChange={() =>
//             setPatientInfo((prev) => ({
//               ...prev,
//               historicoBucal: {
...
//           name="mastigaLados"
//           value="false"
//           checked={patientInfo.historicoBucal?.mastigaLados === "false"}
//           onChange={() =>
//             setPatientInfo((prev) => ({
//               ...prev,
//               historicoBucal: {
...
//           name="rangeDentes"
//           value="true"
//           checked={patientInfo.historicoBucal?.rangeDentes === "true"}
//           onChange={() =>
//             setPatientInfo((prev) => ({
//               ...prev,
//               historicoBucal: {
...
//           name="rangeDentes"
//           value="false"
//           checked={patientInfo.historicoBucal?.rangeDentes === "false"}
//           onChange={() =>
//             setPatientInfo((prev) => ({
//               ...prev,
//               historicoBucal: {
...
//           name="apreensivoTratamento"
//           value="true"
//           checked={patientInfo.historicoBucal?.apreensivoTratamento === "true"}
//           onChange={() =>
//             setPatientInfo((prev) => ({
//               ...prev,
//               historicoBucal: {
//                 ...prev.historicoBucal,
//                 apreensivoTratamento: "true",
//               },
//             }))
//           }
//         />{" "}
...
//           name="apreensivoTratamento"
//           value="false"
//           checked={patientInfo.historicoBucal?.apreensivoTratamento === "false"}
//           onChange={() =>
//             setPatientInfo((prev) => ({
//               ...prev,
//               historicoBucal: {
//                 ...prev.historicoBucal,
//                 apreensivoTratamento: "false",
//               },
//             }))
//           }
//         />{" "}
...
//           name="gengivaSangra"
//           value="true"
//           checked={patientInfo.historicoBucal?.gengivaSangra === "true"}
//           onChange={() =>
//             setPatientInfo((prev) => ({
//               ...prev,
//               historicoBucal: {
...
//           name="gengivaSangra"
//           value="false"
//           checked={patientInfo.historicoBucal?.gengivaSangra === "false"}
//           onChange={() =>
//             setPatientInfo((prev) => ({
//               ...prev,
//               historicoBucal: {
...
//               historicoBucal: {
//                 ...prev.historicoBucal,
//                 problemaTratamentoOdontologico: "true",
//               },
//             }))
//           }
//         />{" "}
...
//               historicoBucal: {
//                 ...prev.historicoBucal,
//                 problemaTratamentoOdontologico: "false",
//               },
//             }))
//           }
//         />{" "}
...
//           name="metodoAuxiliar"
//           value="true"
//           checked={patientInfo.historicoBucal?.metodoAuxiliar === "true"}
//           onChange={() =>
//             setPatientInfo((prev) => ({
//               ...prev,
//               historicoBucal: {
...
//           name="metodoAuxiliar"
//           value="false"
//           checked={patientInfo.historicoBucal?.metodoAuxiliar === "false"}
//           onChange={() =>
//             setPatientInfo((prev) => ({
//               ...prev,
//               historicoBucal: {
//                 ...prev.historicoBucal,
//                 metodoAuxiliar: "false",
//               },
//             }))
//           }
//         />{" "}
...
//           name="usaProteseImplante"
//           value="true"
//           checked={patientInfo.historicoBucal?.usaProteseImplante === "true"}
//           onChange={() =>
//             setPatientInfo((prev) => ({
//               ...prev,
//               historicoBucal: {
//                 ...prev.historicoBucal,
//                 usaProteseImplante: "true",
//               },
//             }))
//           }
//         />{" "}
...
//           name="usaProteseImplante"
//           value="false"
//           checked={patientInfo.historicoBucal?.usaProteseImplante === "false"}
//           onChange={() =>
//             setPatientInfo((prev) => ({
//               ...prev,
//               historicoBucal: {
//                 ...prev.historicoBucal,
//                 usaProteseImplante: "false",
//               },
//             }))
//           }
//         />{" "}
...
//           name="feridaBoca"
//           value="true"
//           checked={patientInfo.historicoBucal?.feridaBoca === "true"}
//           onChange={(e) =>
//             setPatientInfo((prev) => ({
//               ...prev,
//               historicoBucal: {
//                 ...prev.historicoBucal,
//                 feridaBoca: e.target.value,
//               },
//             }))
//           }
//         />{" "}
...
//           name="feridaBoca"
//           value="false"
//           checked={patientInfo.historicoBucal?.feridaBoca === "false"}
//           onChange={(e) =>
//             setPatientInfo((prev) => ({
//               ...prev,
//               historicoBucal: {
...
//         />{" "}
//         Não
//         {patientInfo.historicoBucal?.feridaBoca === "true" && (
//           <input
//             type="text"
//             name="feridaBocaDetails"
//             placeholder="Detalhes da ferida"
        ...
        <div className="radio-group">
          <label>
            <input
              ...
              value="true"
              checked={
                patientInfo.historicoBucal?.apreensivoTratamento === "true"
              }
              onChange={() =>
                setPatientInfo((prev) => ({
                  ...prev,
          ...
          <label>
            <input
              ...
              value="false"
              checked={
                patientInfo.historicoBucal?.apreensivoTratamento === "false"
              }
              onChange={() =>
                setPatientInfo((prev) => ({
                  ...prev,
        ...
        <div className="radio-group">
          <label>
            <input
              ...
              value="true"
              checked={
                patientInfo.historicoBucal?.usaProteseImplante === "true"
              }
              onChange={() =>
                setPatientInfo((prev) => ({
                  ...prev,
          ...
          <label>
            <input
              ...
              value="false"
              checked={
                patientInfo.historicoBucal?.usaProteseImplante === "false"
              }
              onChange={() =>
                setPatientInfo((prev) => ({
                  ...prev,
        ...
        <div className="radio-group">
          ...
          <label>
            <input
              ...
              value="false"
              checked={
                patientInfo.historicoBucal?.dentesAfetamSaude === "false"
              }
              onChange={(e) =>
                setPatientInfo((prev) => ({
                  ...prev,
