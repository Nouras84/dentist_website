...
//     try {
//       const response = await saveData(relevantInfo);
//       alert("Informações gerais atualizadas com sucesso!");
//       console.log("Response Data:", response.data);
//     } catch (error) {
//       console.error("Failed to update general information", error);
...
import { usePatientInfo } from "../../../context/PatientContext"; // Ensure the path is correct
import { useParams } from "react-router-dom";
import "./styles.css"; // Import the specific CSS for this component
            ...
            <div className="radio-group">
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.tratamentoMedico === "não"
                  }
                  onChange={handleChange}
                />
                Não
            ...
            <div className="radio-group">
              <label>
                <input
                  ...
                  value="sim"
                  checked={
                    patientInfo?.informacoesGerais?.alergiaMedicamentosa ===
                    "sim"
                  }
                  onChange={handleChange}
                />
            ...
            <div className="radio-group">
              <label>
                <input
                  ...
                  value="sim"
                  checked={
                    patientInfo?.informacoesGerais?.consideraNervoso === "sim"
                  }
                  onChange={handleChange}
                />
                Sim
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.consideraNervoso === "não"
                  }
                  onChange={handleChange}
                />
                Não
          ...
          <div className="form-group">
            ...
            <div className="radio-group">
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.alergiaOutros === "não"
                  }
                  onChange={handleChange}
                />
                Não
            ...
            {patientInfo?.informacoesGerais?.alergiaOutros === "sim" && (
              <input
                ...
                placeholder="Detalhes da alergia a outros agentes"
                value={
                  patientInfo?.informacoesGerais?.alergiaOutrosDetails || ""
                }
                onChange={handleChange}
              />
            )}
            ...
            <div className="radio-group">
              <label>
                <input
                  ...
                  value="sim"
                  checked={
                    patientInfo?.informacoesGerais?.consideraAnsioso === "sim"
                  }
                  onChange={handleChange}
                />
                Sim
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.consideraAnsioso === "não"
                  }
                  onChange={handleChange}
                />
                Não
            ...
            <div className="radio-group">
              <label>
                <input
                  ...
                  value="sim"
                  checked={
                    patientInfo?.informacoesGerais?.vomitaFrequentemente ===
                    "sim"
                  }
                  onChange={handleChange}
                />
            ...
            <div className="radio-group">
              <label>
                <input
                  ...
                  value="sim"
                  checked={
                    patientInfo?.informacoesGerais?.amamentando === "sim"
                  }
                  onChange={handleChange}
                />
                Sim
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.amamentando === "não"
                  }
                  onChange={handleChange}
                />
                Não
            ...
            <div className="radio-group">
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.faltaArCansaco === "não"
                  }
                  onChange={handleChange}
                />
                Não
            ...
            <div className="radio-group">
              <label>
                <input
                  ...
                  value="sim"
                  checked={
                    patientInfo?.informacoesGerais?.alteracaoPressao === "sim"
                  }
                  onChange={handleChange}
                />
                Sim
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.alteracaoPressao === "não"
                  }
                  onChange={handleChange}
                />
                Não
            ...
            <div className="radio-group">
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.historicoInfarto === "não"
                  }
                  onChange={handleChange}
                />
                Não
          ...
          <div className="form-group">
            ...
            <div className="radio-group">
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.historicoAVC === "não"
                  }
                  onChange={handleChange}
                />
                Não
            ...
            {patientInfo?.informacoesGerais?.historicoAVC === "sim" && (
              <input
                ...
                placeholder="Detalhes do AVC"
                value={
                  patientInfo?.informacoesGerais?.historicoAVCDetails || ""
                }
                onChange={handleChange}
              />
            )}
          ...
          <div className="form-group">
            ...
            <div className="radio-group">
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.historicoAsma === "não"
                  }
                  onChange={handleChange}
                />
                Não
            ...
            {patientInfo?.informacoesGerais?.historicoAsma === "sim" && (
              <input
                ...
                placeholder="Detalhes da asma"
                value={
                  patientInfo?.informacoesGerais?.historicoAsmaDetails || ""
                }
                onChange={handleChange}
              />
            )}
            ...
            <div className="radio-group">
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.tuberculose === "não"
                  }
                  onChange={handleChange}
                />
                Não
            ...
            <div className="radio-group">
              <label>
                <input
                  ...
                  value="sim"
                  checked={
                    patientInfo?.informacoesGerais?.sedeConstante === "sim"
                  }
                  onChange={handleChange}
                />
                Sim
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.sedeConstante === "não"
                  }
                  onChange={handleChange}
                />
                Não
            ...
            <div className="radio-group">
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.desmaioDistrimia === "não"
                  }
                  onChange={handleChange}
                />
                Não
            ...
            <div className="radio-group">
              <label>
                <input
                  ...
                  value="sim"
                  checked={
                    patientInfo?.informacoesGerais?.dificuldadeMastigar ===
                    "sim"
                  }
                  onChange={handleChange}
                />
          ...
          <div className="form-group">
            ...
            <div className="radio-group">
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.tpmMenopausa === "não"
                  }
                  onChange={handleChange}
                />
                Não
            ...
            {patientInfo?.informacoesGerais?.tpmMenopausa === "sim" && (
              <input
                ...
                placeholder="Detalhes de TPM ou Menopausa"
                value={
                  patientInfo?.informacoesGerais?.tpmMenopausaDetails || ""
                }
                onChange={handleChange}
              />
            )}
          ...
          <div className="form-group">
            ...
            <div className="radio-group">
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.calculoRenal === "não"
                  }
                  onChange={handleChange}
                />
                Não
            ...
            {patientInfo?.informacoesGerais?.calculoRenal === "sim" && (
              <input
                ...
                placeholder="Detalhes de cálculo ou insuficiência renal"
                value={
                  patientInfo?.informacoesGerais?.calculoRenalDetails || ""
                }
                onChange={handleChange}
              />
            )}
            ...
            <div className="radio-group">
              <label>
                <input
                  ...
                  value="sim"
                  checked={
                    patientInfo?.informacoesGerais?.osteoporose === "sim"
                  }
                  onChange={handleChange}
                />
                Sim
              ...
              <label>
                <input
                  ...
                  value="não"
                  checked={
                    patientInfo?.informacoesGerais?.osteoporose === "não"
                  }
                  onChange={handleChange}
                />
                Não
            ...
            <div className="radio-group">
              <label>
                <input
                  ...
                  checked={
                    patientInfo?.informacoesGerais
                      ?.sangramentoPosTraumaCirurgia === "sim"
                  }
                  onChange={handleChange}
                />
                Sim
              ...
              <label>
                <input
                  ...
                  checked={
                    patientInfo?.informacoesGerais
                      ?.sangramentoPosTraumaCirurgia === "não"
                  }
                  onChange={handleChange}
                />
                Não
